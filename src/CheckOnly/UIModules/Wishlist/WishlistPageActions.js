                                            ...
                                            ExecuteMYSqliteDBOperations.updateWithQuery(
                                                ...
                                                (responseJSON) => {
                                                    if (responseJSON.status_code === SUCCESS_STATUS_CODE) {
                                                        ...
                                                        ErrorEventLogger('WishlistPageActions >>>> fetchSyncAllExpense >>>> SYNC_SUCCESS_MESSAGE: ', SYNC_SUCCESS_MESSAGE);
                                                        ...
                                                        ErrorEventLogger('WishlistPageActions >>>> fetchSyncAllExpense >>>> CATCH_TRIGGERED_MESSAGE: ', CATCH_TRIGGERED_MESSAGE);
                                                    }
                                                },
                                                (error) => {
                                                    dispatchSyncAllExpense(getSyncAllExpenseFailure(CATCH_TRIGGERED_MESSAGE));
                                                    ErrorEventLogger('WishlistPageActions >>>> fetchSyncAllExpense >>>> error: ', error);
                                                });
                                        });
                                    }
                                })
